...
be needed in the future, unless adding a flavour divinumofficium
supports and we don’t, or building a radically different structure.

Note that if you just want to edit *content*, you should edit it
